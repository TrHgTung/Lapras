...
<main class="container">
  <div class="d-flex align-items-center p-3 my-3 text-white bg-purple rounded shadow-sm">
    <div class="lh-1">
      <h1 class="h6 mb-0 text-white lh-1">Lịch đặt xe của <?php echo Session::get('email'); ?></h1>
      <div class="mt-2">
        <small>Hãy kiểm tra lịch đã đặt của bạn</small>
      </div>
    </div>
  </div>
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-0">Toàn bộ tuyến</h6>
    @foreach($getDataGioHang as $dtagh)
    <div class="d-flex text-body-secondary pt-3">
      <div class="lh-sm border-bottom w-100">
        <div class="table-responsive">
            <table class="table table-striped table-sm">
                <thead>
                <tr>
                    <th scope="col">Mã tuyến đã đặt</th>
                    <th scope="col">Giá theo tuyến</th>
                    <th scope="col"></th>
                    <th scope="col"></th>
                </tr>
                </thead>
                <tbody>
                    <tr>                   
                        ...
                        <td><td><form action="{{URL::to('/hd7374748hfj899494/forcexoagiohang')}}" method="post">
                            ...
                            <input type="hidden" name="MaTuyenXe" value="{{ $dtagh->MaTuyenXe }}">
                            <input type="hidden" name="GiaVe" value="{{ $dtagh->GiaVe }}">
                            <input type="submit" class="btn btn-danger btn-sm" value="Xóa mục này">
                        </form></td></td>
                    </tr>
                </tbody>
            </table>
